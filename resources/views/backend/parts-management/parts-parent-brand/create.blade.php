                ...
                <div class="card-body">
                    <form action="{{ isset($partsParentBrand) ? route('admin.parts-parent-brands.update', $partsParentBrand->id) : route('admin.parts-parent-brands.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-8">
                                <textarea type="text" name="description" class="form-control" placeholder="Parts Parent Brand Description" id="" cols="30" rows="5">{{ isset($partsParentBrand) ? $partsParentBrand->description : '' }}</textarea>
                            </div>
                        </div>
                        <div class="row mt-3">
