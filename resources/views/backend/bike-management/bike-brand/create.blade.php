...
@section('title', 'Create Bike Brand Categories')
                ...
                <div class="card-body">
                    <form action="{{ isset($bikeBrand) ? route('admin.bike-brands.update', $bikeBrand->id) : route('admin.bike-brands.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-8">
                                <textarea type="text" name="description" class="form-control" placeholder="Bike Brand Description" id="" cols="30" rows="5">{{ isset($bikeBrand) ? $bikeBrand->description : '' }}</textarea>
                            </div>
                        </div>
                        <div class="row mt-3">
