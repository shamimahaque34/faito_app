                ...
                <div class="card-body">
                    <form action="{{ isset($bikeMotorType) ? route('admin.bike-motor-types.update', $bikeMotorType->id) : route('admin.bike-motor-types.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-8">
                                <textarea type="text" name="other_info" class="form-control" placeholder="Bike Motor Type Other Info" id="" cols="30" rows="5">{{ isset($bikeMotorType) ? $bikeMotorType->other_info : '' }}</textarea>
                            </div>
                        </div>
                        <div class="row mt-3">
