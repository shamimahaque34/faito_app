                ...
                <div class="card-body">
                    <form action="{{ isset($bikeYearVersion) ? route('admin.bike-year-versions.update', $bikeYearVersion->id) : route('admin.bike-year-versions.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-8">
                                <textarea type="text" name="info" class="form-control" placeholder="Bike Year Version Info" id="" cols="30" rows="5">{{ isset($bikeYearVersion) ? $bikeYearVersion->info : '' }}</textarea>
                            </div>
                        </div>
